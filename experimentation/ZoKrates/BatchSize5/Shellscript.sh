...
run_and_monitor "zokrates compile --debug -i root.zok" "Compile"
run_and_monitor "zokrates universal-setup --size 24 --proving-scheme marlin" "Universal Setup"
